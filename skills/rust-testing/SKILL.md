...
1. Identify the behavior contract before writing tests.
...
3. Write at least one failing test before fixing a bug when practical.
4. Keep test data small, explicit, and local to the test.
5. Validate with all relevant feature flags.
